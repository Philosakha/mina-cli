...
export default async function createFrontend() {
    ...
    switch (results.framework) {
        case "NextJS":
            ...
            exec(`git clone https://github.com/Philosakha/Starter-kit-mina-Auro-NEXTJS-13  ${results2.projectName}`, (err, stdout, stderr) => {
                if (err) {
        ...
        case "ReactJS":
            ...
            exec(`git clone https://github.com/Philosakha/starter-kit-mina-auro-react ${results2.projectName}
